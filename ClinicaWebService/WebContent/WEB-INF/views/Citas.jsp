...
<!-- *****************************************************************************************+ -->
	...
	<c:if test="${!empty listaCita}">
	    ...
	    <tbody class="dataServicios">
			<c:forEach items="${listaCita}" var="libro">
				<tr>
					<td>${libro.citaid}</td>
					<td>${libro.fechacita}</td>
					<td>${libro.nombre}</td>
		  ...
		  <div class="row">
				...
				<option value ="2">Carnet de Extranjeria</option>
                     ...
                     <div class="col-md-5">
	                  ...
	                  <input data-rule-required="true" data-rule-validByItem="true" name="myCode" id="numdoc" class="numdoc textbox1" placeholder="Ingresa número de documento " />
                     <label id="sms"></label>
                    </div>
		...
		<div class="row">
		  ...
		  <div class="row">
                    <div class="col-md-5">
                        ...
                        <input data-rule-required="true" name="dir" class="textbox1" id="dir" placeholder =" Ingresa Dirección " />
                    </div>

                    <div class="col-md-5">
                        <b id="label">Teléfono:</b><br/>
                         <input data-rule-required="true" name="tel" class="textbox1" id="tel" placeholder =" Ingresa Teléfono" />
